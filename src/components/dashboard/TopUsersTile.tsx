export const TopUsersTile = () => (
  <div className="row-span-2 col-start-1 row-start-4 bg-[var(--bg-secondary)] text-[var(--text-primary)] flex items-center justify-center flex-col">
    ...
    <div className="flex items-center justify-center py-4">
      <img src="/src/assets/user1.png" alt="User 1" className="w-12 h-12 rounded-full object-cover border-4 border-[var(--bg-primary)]" />
      ...
      <img src="/src/assets/user3.png" alt="User 2" className="-ml-4 w-12 h-12 rounded-full object-cover border-4 border-[var(--bg-primary)]" />
    </div>
  </div>
);
